...
<?php
$sql=mysqli_query($gmr,"SELECT * FROM notices WHERE access='0' ORDER BY id DESC");
...
$fs=mysqli_query($gmr,"SELECT * FROM notices WHERE access='2' ORDER BY id DESC");
while($a=mysqli_fetch_array($fs))
{
	?>
<tr class="info"><td><?php echo $a['title'];?></td><td><?php echo $a['notice'];?></td><td><a href="asl_uploads/<?php echo $a['file'];?>">
<img src="images/dwd.png" height="30" width="30" /></a></td><td><?php echo $a['date'];?></td></tr>
